...
.controller('NavCtrl', function($scope, $ionicSideMenuDelegate, $http, $state) {
    ...
    var url = "http://newsintags.eu-gb.mybluemix.net/GetTwitterUserDetails?callback=JSON_CALLBACK&userName=nebulatechies7";
    $http.jsonp(url)
    ...
    var url = "http://newsintags.eu-gb.mybluemix.net/GetNewsConceptForUser?callback=JSON_CALLBACK&screenName="+screenName;
    $http.jsonp(url)
      .success(function(data){
          console.log(d=data);
          $scope.userConceptDetails = d.conceptDetails;  
    });
    var url = "http://newsintags.eu-gb.mybluemix.net/GetAllConcepts?callback=JSON_CALLBACK";
    $http.jsonp(url)
      .success(function(data){
          console.log(d=data);
    ...
    $scope.showConceptNews = function(id,name){
      ...
      var url="http://newsintags.eu-gb.mybluemix.net/GetNewsForConcept?callback=JSON_CALLBACK&conceptId="+currentConceptId;
  console.log(url);
   var loading= document.getElementsByClassName("conceptNewsloading");
   if(loading.length >0){
      loading[0].style.display = "block";
    }
$scope.currentConceptName = currentConcept;
   $http.jsonp(url)
      .success(function(data){
          console.log(d=data);
    ...
    $scope.addUserTag = function(conceptId, concept){
      $scope.tagList = document.getElementsByClassName("tag-suggest");
        ...
        var url = "http://newsintags.eu-gb.mybluemix.net/AddNewConceptUser?callback=JSON_CALLBACK&conceptId="+conceptId+"&screenName="+screenName;
        console.log(url);
         $http.jsonp(url)
            .success(function(data){
                console.log(d=data);
...
.controller('TrendingTabCtrl', function($scope, $http) {
   ...
   var url = "http://newsintags.eu-gb.mybluemix.net/GetTrendingNews?callback=JSON_CALLBACK";
   $http.jsonp(url)
      .success(function(data){
          console.log(d=data);
...
var url = "http://newsintags.eu-gb.mybluemix.net/GetLatestNews?callback=JSON_CALLBACK";
...
var url = "http://newsintags.eu-gb.mybluemix.net/GetLocationBasedNews?callback=JSON_CALLBACK&location=chennai";
...
.controller('AddSitesCtrl', function($scope) {
})

.controller('PositiveNewsCtrl', function($scope, $http) {
  var url="http://newsintags.eu-gb.mybluemix.net/GetSentimentNews?callback=JSON_CALLBACK&sentiment=positive";
...
.controller('NegativeNewsCtrl', function($scope, $http) {
  var url="http://newsintags.eu-gb.mybluemix.net/GetSentimentNews?callback=JSON_CALLBACK&sentiment=negative";
...
.controller('NeutralNewsCtrl', function($scope, $http) {
  var url="http://newsintags.eu-gb.mybluemix.net/GetSentimentNews?callback=JSON_CALLBACK&sentiment=neutral";
